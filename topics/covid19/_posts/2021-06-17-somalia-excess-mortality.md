...
# figures/somalia_excess_mortality_parampostdistr_dic.png
...
**Conclusions:** Subject to study assumptions, a very early SARS-CoV-2 introduction event may have occurred in Somalia. Estimated transmissibility in the first epidemic wave was lower than observed in European settings.

**Read the pre-print [here](reports/2021-06-17-somalia-excess-mortality.pdf).** Accompanying code can be found [here.](https://github.com/cmmid/covid_quar_test_import_risk)